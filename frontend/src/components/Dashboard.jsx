      ...
      <div className="bg-[#0b2545] border-b border-[#163863] text-xs py-2.5 px-4 sm:px-8 flex items-center justify-between text-slate-200">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-white">
            National Airfare Index • Admin Portal
          </span>
          <span className="hidden md:inline text-slate-400">•</span>
          <span className="hidden md:inline text-amber-300 font-mono">
            Problem SIH26056
          </span>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1.5 text-emerald-300 text-[11px] font-mono">
            ...
            <span>Admin Surveillance Active</span>
          </div>
          <span className="text-slate-400">|</span>
          <span className="text-slate-300 font-mono text-[11px]">
            Node: in-gov-cluster-01
          </span>
        </div>
      </div>
          ...
          <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
            ...
            <div className="flex items-center p-1 rounded-xl bg-slate-100 border border-slate-200">
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold font-mono transition-all ${method === 'jevons'
                    ? 'bg-[#0b2545] text-white shadow-sm font-bold'
                    : 'text-slate-600 hover:text-slate-900'
                  }`}
                title="Unweighted Geometric Mean (Official Standard)"
              >
                Jevons (Geometric)
              </button>
              <button
                onClick={() => setMethod('laspeyres')}
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold font-mono transition-all ${method === 'laspeyres'
                    ? 'bg-[#0b2545] text-white shadow-sm font-bold'
                    : 'text-slate-600 hover:text-slate-900'
                  }`}
